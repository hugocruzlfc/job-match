...
// export function SkeletonJobListingApplicationTable() {
//   return (
//     <JobListingApplicationTable
//       applications={[]}
...
// export function JobListingApplicationTable({
//   applications,
//   canUpdateRating,
//   canUpdateStage,
...
//         >
//           <DialogContent className="flex max-h-[calc(100%-2rem)] flex-col overflow-hidden md:max-w-3xl lg:max-w-5xl">
//             <DialogHeader>
